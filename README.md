...
If you'd like to **contribute** and make this much better for other users, have a look at [Issues](https://github.com/bot0024/portfolio/issues).

Created something awesome for your fork of the portfolio and want to share it? Feel free to open a [pull request](https://github.com/bot0024/portfolio/pulls).
...
git clone https://github.com/bot0024/portfolio.git
...
If the above solution still doesn't work, visit the [wiki page](https://github.com/bot0024/portfolio/wiki/Github-Setup-For-Open-Source-Projects).
...
const socialMediaLinks = {
  ...
  linkedin: "https://www.linkedin.com/in/bot0024/",
  gmail: "dipnalawade@gmail.com",
};
...
[![Deploy To Netlify](https://www.netlify.com/img/deploy/button.svg)](https://app.netlify.com/start/deploy?repository=https://github.com/bot0024/portfolio)
...
## For the Future
If you can help us with these. Please don't hesitate to open a [pull request](https://github.com/bot0024/portfolio/pulls).
